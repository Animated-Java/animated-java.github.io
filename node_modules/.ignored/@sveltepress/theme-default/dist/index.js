...
var VIRTUAL_PWA = 'virtual:pwa-info';
var VIRTUAL_PWA_SVELTE_REGISTER = 'virtual:pwa-register/svelte';
export var themeOptionsRef = {
    value: undefined,
};
var defaultTheme = function (options) {
    var _a;
    themeOptionsRef.value = options;
    var vitePlugins = (function (corePlugin) { return __awaiter(void 0, void 0, void 0, function () {
        var plugins, _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _a = [[]];
                    return [4 /*yield*/, createPreCorePlugins(options)];
                case 1:
                    plugins = __spreadArray.apply(void 0, [__spreadArray.apply(void 0, _a.concat([_b.sent(), true])), [
                            corePlugin,
                        ], false]);
                    if (options === null || options === void 0 ? void 0 : options.pwa) {
                        plugins.push(SvelteKitPWA(__assign({ strategies: 'injectManifest', srcDir: SERVICE_WORKER_PATH.replace(/sw\.js$/, ''), filename: 'sw.js', injectManifest: {
    ...
    return {
        ...
        footnoteLabel: (_a = options === null || options === void 0 ? void 0 : options.i18n) === null || _a === void 0 ? void 0 : _a.footnoteLabel,
    };
};
