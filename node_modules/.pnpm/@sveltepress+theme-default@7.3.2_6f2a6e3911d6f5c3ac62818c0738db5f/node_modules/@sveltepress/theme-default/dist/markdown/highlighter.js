...
var highlighter = function (code, lang, meta) { return __awaiter(void 0, void 0, void 0, function () {
    var cacheKey, cached, prepared, _a;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                prepared = prepareCodeBlock(code, meta);
                _a = wrapCodeBlock;
                return [4 /*yield*/, _highlighter(prepared.processedCode, lang, meta)];
            case 1:
                cached = _a.apply(void 0, [_b.sent(), lang,
                    prepared,
                    {
